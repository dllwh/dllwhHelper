 ...
 * @创建时间: 2019-08-20 7:12:16 PM
 * @版本: V1.0.1
 * @since: JDK 1.8
 */
public class TableProperty implements Serializable {
	private static final long serialVersionUID = -7605066195832079209L;
	/** 列对应的表名 */
	...
	public String toString() {
		return "TableProperty [tableName=" + tableName + ", category=" + category + ", tableSchem=" + tableSchem
				+ ", tableComment=" + tableComment + ", tableType=" + tableType + ", columns=" + columns + ", objName="
				+ objName + ", className=" + className + ", createTime=" + createTime + ", indexKeyInfo=" + indexKeyInfo
				+ "]";
	}
}