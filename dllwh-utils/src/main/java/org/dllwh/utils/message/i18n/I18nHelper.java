package org.dllwh.utils.message.i18n;
 ...
 *               <li>④.Locale(String language,String country):根据指定国家和语言创建一个语言环境
 *               </li>
...
public class I18nHelper {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
		ResourceBundle bundle = ResourceBundle.getBundle("properties.myResources.messages", defaultLocale);
		// 3.通过资源包获取locale相关信息
