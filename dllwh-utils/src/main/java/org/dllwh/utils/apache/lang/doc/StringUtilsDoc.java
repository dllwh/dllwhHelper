...
interface StringUtilsDoc {
	 ...
	 * @方法:二三参数对应的数组，查找二参数数组一样的值，替换三参数对应数组的值
	 */
	public String replaceEachRepeatedly(final String text, final String[] searchList,
	 ...
	 * @方法:
	 */
	public String prependIfMissing(final String str, final CharSequence prefix,
