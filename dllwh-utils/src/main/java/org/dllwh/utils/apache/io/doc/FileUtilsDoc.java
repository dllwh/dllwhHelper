 ...
 *
 * @类描述: FileUtils 方法说明文档
 * @创建者: 独泪了无痕--duleilewuhen@sina.com
 * @创建时间: 2018年11月11日 下午11:21:54
 * @版本: V1.0.1
 * @since: JDK 1.7
 */
public interface FileUtilsDoc {
	...
	public Iterator<File> iterateFiles(File directory, IOFileFilter fileFilter,
	...
	/** 根据一个IOFileFilter过滤规则获取一个目录下的文件集合的Iterator迭代器 */
	public Iterator<File> iterateFilesAndDirs(File directory, IOFileFilter fileFilter,
			IOFileFilter dirFilter);
	...
	public Collection<File> listFiles(File directory, IOFileFilter fileFilter,
			IOFileFilter dirFilter);
	...
	/** 根据一个IOFileFilter过滤规则获取一个目录下的文件集合 */
	public Collection<File> listFilesAndDirs(File directory, IOFileFilter fileFilter,
			IOFileFilter dirFilter);
