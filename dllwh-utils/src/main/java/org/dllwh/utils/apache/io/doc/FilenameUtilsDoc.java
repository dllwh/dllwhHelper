package org.dllwh.utils.apache.io.doc;
 ...
 *
 * @类描述: FilenameUtils方法说明文档
 * @创建者: 独泪了无痕--duleilewuhen@sina.com
 * @创建时间: 2018年11月11日 下午11:21:05
 * @版本: V1.0.1
 * @since: JDK 1.7
 */
interface FilenameUtilsDoc {
	...
	public boolean equals(String fullFileName, String linuxFileName, boolean normalized,
			IOCase caseSensitivity);

	/** 判断文件路径是否相同，格式化并大小写敏感: */
	public boolean equalsNormalized(String fullFileName, String linuxFileName);

	public boolean equalsNormalizedOnSystem(String fullFileName, String linuxFileName);
	...
	/** 判断文件扩展名是否包含在指定集合中 */
	public boolean isExtension(String fullFileName, Collection<String> extensions);
	...
	public boolean wildcardMatch(String fileName, String wildcardMatcher, IOCase caseSensitivity);
