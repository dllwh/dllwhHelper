...
public class AESHelper {
	...
	public static String decrypt(String decryptData, String iv, String key, String decryptType,
			String decryMode) throws InvalidKeyException, InvalidAlgorithmParameterException, Exception {
		byte[] sessionKeyByte = Base64.decodeBase64(key.getBytes());
		byte[] ivByte = Base64.decodeBase64(iv.getBytes());
		byte[] encryptDataByte = Base64.decodeBase64(decryptData.getBytes());
		// 初始化
